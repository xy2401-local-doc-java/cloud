...
var tSchema = "E85464-01";
var partNumber = "E85464-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85464-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85464-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85464-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85464-01/docindex"
  };
...
var l10n = {
    ...
    show_navigation         : "Navigáció megjelenítése",
    hide_navigation         : "elrejt Navigáció",
    search_button           : "Keresés",
    this_book               : "Ez a Könyv",
    advanced_search         : "Advanced Search",
    hide                    : "elrejt",
    show                    : "mutat",
    reference               : "Hivatkozás",
    home                    : "Kezdőlap",
    master_index            : "Mester Index",
    master_glossary         : "Fő Gogalomtár",
    master_book_list        : "Mester Book List",
    main_categories         : "kategória",
    security                : "Biztonság",
    contents                : "Tartalomjegyzék",
    new_changed             : "Új és módosított dokumentumok",
    reader_comment          : "Reader Megjegyzés",
    subject                 : "tárgy",
    from                    : "-tól",
    anonymous               : "Névtelen",
    or                      : " (vagy ",
    sign_in                 : "Bejelentkezés",
    comment_first_part      : "Megjegyzéseket, javításokat, és javaslatokat továbbítja szerzők minden héten.",
    comment_second_part     : "Benyújtásával, Ön megerősíti, elfogadja, hogy a ",
    comment_third_part      : "feltételek",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Használja a ",
    comment_fifth_part_otn  : "OTN fórumok",
    comment_sixth_part      : " a termékkel kapcsolatos kérdéseire. ",
    comment_seventh_part    : "A támogatás vagy tanácsadás, nyújtson be kérelmet a szolgáltatás ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Előterjeszt",
    need_an_example         : "Szüksége van egy példát?",
    tell_us_more            : "Mondja el nekünk több",
    click_to_expand         : "Kattintson bővíteni",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85464_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "hu" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "hu" +
      "/comment_disclaimer.htm";
  }
