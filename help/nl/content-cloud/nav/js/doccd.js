...
var tSchema = "E85452-01";
var partNumber = "E85452-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85452-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85452-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85452-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85452-01/docindex"
  };
...
var l10n = {
    ...
    hide_navigation         : "verbergen navigatie",
    ...
    home                    : "Intro",
    master_index            : "Master Index",
    master_glossary         : "Master Woordenlijst",
    master_book_list        : "Master Book List",
    main_categories         : "categorieën",
    security                : "Veiligheid",
    contents                : "Inhoudsopgave",
    new_changed             : "Nieuwe en gewijzigde documenten",
    reader_comment          : "Lezer Reactie",
    subject                 : "onderwerp",
    from                    : "van",
    anonymous               : "Anoniem",
    or                      : " (of ",
    sign_in                 : "inloggen",
    comment_first_part      : "Commentaar, correcties en suggesties worden elke week toegezonden aan auteurs.",
    comment_second_part     : "Door het indienen, bevestig je dat je akkoord gaat met de ",
    comment_third_part      : "voorwaarden",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Gebruik de ",
    comment_fifth_part_otn  : "OTN forums",
    comment_sixth_part      : " voor product vragen. ",
    comment_seventh_part    : "Voor ondersteuning of advies, dient u een service request door ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Voorleggen",
    need_an_example         : "Hebt u een voorbeeld?",
    tell_us_more            : "Vertel ons meer",
    click_to_expand         : "Klik om te vergroten",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85452_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "nl" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "nl" +
      "/comment_disclaimer.htm";
  }
