...
var tSchema = "E85476-01";
var partNumber = "E85476-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85476-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85476-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85476-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85476-01/docindex"
  };
...
var l10n = {
    ...
    show_navigation         : "Mostra di navigazione",
    ...
    home                    : "Home",
    master_index            : "Master Index",
    master_glossary         : "Maestro Glossario",
    master_book_list        : "Maestro Prenota List",
    main_categories         : "Categorie",
    security                : "Sicurezza",
    contents                : "Sommario",
    new_changed             : "Nuovi e modificati i documenti",
    reader_comment          : "Reader commento",
    subject                 : "soggetto",
    from                    : "da",
    anonymous               : "Anonimo",
    or                      : " (o ",
    sign_in                 : "Accedi",
    comment_first_part      : "Commenti, correzioni e suggerimenti sono inoltrati agli autori ogni settimana.",
    comment_second_part     : "Inviando, si conferma l'utente accetta la ",
    comment_third_part      : "termini e le condizioni",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Utilizzare il ",
    comment_fifth_part_otn  : "forum di OTN",
    comment_sixth_part      : " fer informazioni sui prodotti. ",
    comment_seventh_part    : "Per supporto o di consulenza, presentare una richiesta di servizio attraverso ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Presentare",
    need_an_example         : "Un esempio?",
    tell_us_more            : "Parla con noi",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85476_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "it" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "it" +
      "/comment_disclaimer.htm";
  }
