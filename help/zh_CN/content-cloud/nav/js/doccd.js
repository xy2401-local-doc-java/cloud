...
var tSchema = "E85447-01";
var partNumber = "E85447-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85447-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85447-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85447-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85447-01/docindex"
  };
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85447_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "zh-CN" +
