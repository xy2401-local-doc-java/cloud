...
var tSchema = "E85473-01";
var partNumber = "E85473-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85473-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85473-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85473-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85473-01/docindex"
  };
...
var l10n = {
    ...
    hide_navigation         : "Dölj navigeringen",
    search_button           : "Sök",
    this_book               : "denna bok",
    ...
    reference               : "Referens",
    home                    : "Hem",
    master_index            : "Mästare Index",
    master_glossary         : "Master Glossary",
    master_book_list        : "Mästare boklista",
    main_categories         : "Kategorier",
    security                : "Säkerhet",
    contents                : "Innehåll",
    new_changed             : "Nya och ändrade dokument",
    ...
    or                      : " (eller ",
    sign_in                 : "Logga in",
    comment_first_part      : "Kommentarer, rättelser och förslag vidarebefordras till författare varje vecka.",
    comment_second_part     : "Genom att skicka in, bekräftar du att du samtycker till ",
    comment_third_part      : "villkor",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Använd ",
    comment_fifth_part_otn  : "OTN forum",
    comment_sixth_part      : " för andra frågor. ",
    comment_seventh_part    : "För support eller rådgivning, lämna in en felanmälan via ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Submit",
    need_an_example         : "Behöver ett exempel?",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85473_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "sv" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "sv" +
      "/comment_disclaimer.htm";
  }
