...
var tSchema = "E85475-01";
var partNumber = "E85475-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85475-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85475-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85475-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85475-01/docindex"
  };
...
var l10n = {
    ...
    home                    : "Inicio",
    master_index            : "Maestro Index",
    master_glossary         : "Glosario principal",
    master_book_list        : "Lista de libros Maestro",
    main_categories         : "Categorías",
    security                : "Seguridad",
    contents                : "Contenido",
    new_changed             : "Nuevos y modificados documentos",
    reader_comment          : "Lector comentario",
    subject                 : "tema",
    from                    : "de",
    anonymous               : "Anónimo",
    or                      : " (o ",
    sign_in                 : "Ingresar",
    comment_first_part      : "Comentarios, correcciones y sugerencias son enviadas a los autores todas las semanas.",
    comment_second_part     : "Al enviar, usted confirma que está de acuerdo con el ",
    comment_third_part      : "términos y condiciones",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Utilice el ",
    comment_fifth_part_otn  : "foros OTN",
    comment_sixth_part      : " para preguntas sobre productos. ",
    comment_seventh_part    : "Para obtener asistencia o consultoría, presente una solicitud de servicio a través ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Presentar",
    need_an_example         : "¿Necesitas un ejemplo?",
    tell_us_more            : "Cuéntenos más",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85475_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "es" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "es" +
      "/comment_disclaimer.htm";
  }
