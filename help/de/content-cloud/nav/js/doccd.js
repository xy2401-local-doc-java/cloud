...
var tSchema = "E85466-01";
var partNumber = "E85466-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85466-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85466-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85466-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85466-01/docindex"
  };
...
var l10n = {
    ...
    home                    : "Startseite",
    master_index            : "Master-Index",
    master_glossary         : "Master-Glossar",
    master_book_list        : "Master-Book List",
    main_categories         : "Kategorien",
    security                : "Sicherheit",
    contents                : "Inhalte",
    new_changed             : "Neue und geänderte Dokumente",
    reader_comment          : "Reader Kommentar",
    subject                 : "unterworfen",
    from                    : "von",
    anonymous               : "Anonymous",
    or                      : " (oder ",
    sign_in                 : "Anmelden",
    comment_first_part      : "Kommentare, Korrekturen und Anregungen sind Autoren weitergeleitet jede Woche.",
    comment_second_part     : "Mit dem Absenden bestätigen Sie, stimmen Sie zu, die ",
    comment_third_part      : "Bedingungen und Konditionen",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Verwenden Sie die ",
    comment_fifth_part_otn  : "OTN Foren",
    comment_sixth_part      : " für Produktfragen. ",
    comment_seventh_part    : "Für Unterstützung oder Beratung, Einreichung einer Service-Anfrage durch ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Einreichen",
    need_an_example         : "Brauchen Sie ein Beispiel nennen?",
    tell_us_more            : "Berichten Sie uns etwas",
    click_to_expand         : "Klicken Sie zum Vergrößern",
    expand_all              : "Alle erweitern",
    collapse_all            : "Alles schließen"
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85466_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "de" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "de" +
      "/comment_disclaimer.htm";
  }
