...
var tSchema = "E85410-01";
var partNumber = "E85410-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85410-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85410-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85410-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85410-01/docindex"
  };
...
var l10n = {
    ...
    hide_navigation         : "Esconder navegação",
    search_button           : "pesquisar",
    this_book               : "este Livro",
    advanced_search         : "Busca Avançada",
    hide                    : "esconder",
    show                    : "mostrar",
    reference               : "Referência",
    home                    : "Início",
    master_index            : "Mestre Index",
    master_glossary         : "mestre Glossário",
    master_book_list        : "Lista de Livros Mestre",
    main_categories         : "Categorias",
    security                : "Segurança",
    contents                : "Conteúdo",
    new_changed             : "Novos e alterados documentos",
    reader_comment          : "Leitor Comentário",
    subject                 : "assunto",
    from                    : "de",
    anonymous               : "Anônimo",
    or                      : " (ou ",
    sign_in                 : "Iniciar Sessão",
    comment_first_part      : "Comentários, correções e sugestões são encaminhadas aos autores a cada semana.",
    comment_second_part     : "Ao enviar, você confirma que concorda com o ",
    comment_third_part      : "termos e condições",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Use o ",
    comment_fifth_part_otn  : "OTN fóruns",
    comment_sixth_part      : " para questões sobre produtos. ",
    comment_seventh_part    : "Para suporte ou consultoria, apresentar uma solicitação de serviço através ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Submeter",
    need_an_example         : "Precisa de um exemplo?",
    tell_us_more            : "Conte-nos mais",
    click_to_expand         : "Clique para ampliar",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85410_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "pt-BR" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "pt-BR" +
      "/comment_disclaimer.htm";
  }
