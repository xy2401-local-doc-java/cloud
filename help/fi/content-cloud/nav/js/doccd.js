...
var tSchema = "E85462-01";
var partNumber = "E85462-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85462-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85462-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85462-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85462-01/docindex"
  };
...
var l10n = {
    ...
    show_navigation         : "Näytä Navigointi",
    hide_navigation         : "piilottaa suunnistus",
    search_button           : "Etsi",
    this_book               : "Tämä kirja",
    ...
    home                    : "Koti",
    master_index            : "Master Index",
    master_glossary         : "Master sanasto",
    master_book_list        : "Master Teosluettelon",
    main_categories         : "Kategoriat",
    security                : "Security",
    contents                : "Sisältö",
    new_changed             : "Uudet ja muuttuneet asiakirjat",
    reader_comment          : "Lukija Kommentti",
    subject                 : "aihe",
    from                    : "alkaen",
    anonymous               : "Anonyymi",
    or                      : " (tai ",
    sign_in                 : "Kirjaudu sisään",
    comment_first_part      : "Kommentit, korjaukset ja ehdotukset toimitetaan tekijöille joka viikko.",
    comment_second_part     : "Lähettämällä, olet vahvistanut sitoudut ",
    comment_third_part      : "ehdot",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Käytä ",
    comment_fifth_part_otn  : "OTN foorumit",
    comment_sixth_part      : " muut kysymykset. ",
    comment_seventh_part    : "Tukea tai konsultointi, tee palvelupyyntö kautta ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Esittää",
    need_an_example         : "Tarvitsetko esimerkki?",
    tell_us_more            : "Kerro lisää",
    click_to_expand         : "Klikkaa laajentaa",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85462_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "fi" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "fi" +
      "/comment_disclaimer.htm";
  }
