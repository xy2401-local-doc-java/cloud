...
var tSchema = "E85443-01";
var partNumber = "E85443-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85443-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85443-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85443-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85443-01/docindex"
  };
...
var l10n = {
    ...
    show_navigation         : "顯示導航",
    hide_navigation         : "隱藏導航",
    search_button           : "搜索",
    this_book               : "這本書",
    ...
    or                      : " （或 ",
    sign_in                 : "登錄",
    comment_first_part      : "轉發評論，更正，並建議作者每週。",
    comment_second_part     : "通過提交，你確認你同意 ",
    comment_third_part      : "條款和條件",
    comment_fourth_part     : "。 ",
    comment_fifth_part      : "使用 ",
    comment_fifth_part_otn  : "OTN論壇",
    comment_sixth_part      : " 產品問題。 ",
    comment_seventh_part    : "對於支持或諮詢服務，通過提交服務請求 ",
    comment_eighth_part     : "My Oracle Support的",
    submit                  : "提交",
    need_an_example         : "需要一個例子嗎？ ",
    tell_us_more            : "請告訴我們更多",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85443_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "zh-TW" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "zh-TW" +
      "/comment_disclaimer.htm";
  }
