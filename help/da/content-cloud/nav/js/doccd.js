...
var tSchema = "E85459-01";
var partNumber = "E85459-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85459-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85459-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85459-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85459-01/docindex"
  };
...
var l10n = {
    ...
    home                    : "Hjem",
    master_index            : "Master Index",
    master_glossary         : "Master Ordliste",
    master_book_list        : "Master Bogliste",
    main_categories         : "kategorier",
    security                : "Sikkerhed",
    contents                : "Indhold",
    new_changed             : "Nye og ændrede dokumenter",
    reader_comment          : "Læser Kommentar",
    subject                 : "Emne",
    from                    : "fra",
    anonymous               : "Anonymous",
    or                      : " (eller ",
    sign_in                 : "Log Ind",
    comment_first_part      : "Kommentarer, rettelser og forslag sendes til forfatterne hver uge.",
    comment_second_part     : "Ved at indgive, bekræfter du, at du accepterer ",
    comment_third_part      : "betingelser og vilkår",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Brug ",
    comment_fifth_part_otn  : "OTN fora",
    comment_sixth_part      : " for produkt spørgsmål. ",
    comment_seventh_part    : "For support eller rådgivning, indgive en service anmodning via ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Indsend",
    need_an_example         : "Brug for et eksempel?",
    tell_us_more            : "Fortæl os mere",
    click_to_expand         : "Klik for at udvide",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85459_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "da" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "da" +
      "/comment_disclaimer.htm";
  }
