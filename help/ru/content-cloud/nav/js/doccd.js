...
var tSchema = "E85472-01";
var partNumber = "E85472-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85472-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85472-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85472-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85472-01/docindex"
  };
...
var l10n = {
    ...
    show_navigation         : "Показать навигации",
    hide_navigation         : "Не показывать навигацию",
    search_button           : "Поиск",
    this_book               : "эта книга",
    ...
    reference               : "ссылка",
    home                    : "Главная",
    master_index            : "главный индекс",
    master_glossary         : "Главный глоссарий",
    master_book_list        : "Мастер Список книг",
    main_categories         : "категории",
    security                : "безопасность",
    contents                : "Оглавление",
    new_changed             : "Новые и измененные документы",
    ...
    or                      : " (или ",
    sign_in                 : "Войти",
    comment_first_part      : "Комментарии, исправления и предложения направляются авторами каждую неделю.",
    comment_second_part     : "Отправляя, Вы подтверждаете, вы соглашаетесь с ",
    comment_third_part      : "постановления и условия",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Используйте ",
    comment_fifth_part_otn  : "OTN форумах",
    comment_sixth_part      : " По вопросам спецификации продукта. ",
    comment_seventh_part    : "Для поддержки или консультаций, подать запрос на обслуживание через ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "представлять",
    need_an_example         : "Нужен пример?",
    tell_us_more            : "Расскажите подробнее",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85472_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "ru" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "ru" +
      "/comment_disclaimer.htm";
  }
