...
var tSchema = "E85450-01";
var partNumber = "E85450-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85450-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85450-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85450-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85450-01/docindex"
  };
...
var l10n = {
    ...
    hide_navigation         : "Ukryj Nawigacja",
    search_button           : "Szukaj",
    this_book               : "Ta książka",
    advanced_search         : "Zaawansowane wyszukiwanie",
    hide                    : "ukryć",
    show                    : "pokazać",
    reference               : "Odniesienie",
    home                    : "Strona startowa",
    master_index            : "Mistrz Index",
    master_glossary         : "Mistrz Słowniczek",
    master_book_list        : "Mistrz listy książek",
    main_categories         : "kategorie",
    security                : "Zabezpieczenia",
    contents                : "Zawartość",
    new_changed             : "Nowe i zmienione dokumenty",
    reader_comment          : "Komentarz Reader",
    subject                 : "przedmiot",
    from                    : "z",
    anonymous               : "Anonimowy",
    or                      : " (lub ",
    sign_in                 : "Zaloguj się",
    comment_first_part      : "Komentarze, poprawki i sugestie przekazywane są do autorów co tydzień.",
    comment_second_part     : "Przesyłając, potwierdzasz, zgadzasz się ",
    comment_third_part      : "warunki",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Użyj ",
    comment_fifth_part_otn  : "OTN forum",
    comment_sixth_part      : " na pytania dotyczące produktów. ",
    comment_seventh_part    : "Dla wsparcia lub konsultacji, złożyć zlecenie usługi poprzez ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Przedkładać",
    need_an_example         : "Chcesz przykład?",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85450_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "pl" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "pl" +
      "/comment_disclaimer.htm";
  }
