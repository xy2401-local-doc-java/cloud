...
var tSchema = "E85437-01";
var partNumber = "E85437-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85437-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85437-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85437-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85437-01/docindex"
  };
...
var l10n = {
    ...
    reference               : "참고",
    home                    : "홈",
    master_index            : "마스터 인덱스",
    master_glossary         : "마스터 용어집",
    master_book_list        : "마스터 도서 목록",
    main_categories         : "카테고리",
    security                : "보안",
    contents                : "목차",
    new_changed             : "새로운 기능과 변경된 문서 ",
    reader_comment          : "독자 의견",
    subject                 : "제목",
    from                    : "자",
    anonymous               : "익명",
    or                      : " (또는 ",
    sign_in                 : "로그인",
    comment_first_part      : "메모, 수정, 및 제안 매주 작성자에게 전달됩니다.",
    comment_second_part     : "제출함으로써, 당신은 동의 확인 ",
    comment_third_part      : "이용 약관",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "를 사용하여 ",
    comment_fifth_part_otn  : "OTN 포럼",
    comment_sixth_part      : " 제품 질문. ",
    comment_seventh_part    : "지원이나 컨설팅을 통해 서비스 요청을 제기 ",
    comment_eighth_part     : "내 오라클 지원",
    submit                  : "제출",
    need_an_example         : "예를 들어이 필요하십니까?",
    tell_us_more            : "질문과 대답",
    click_to_expand         : "클릭하여 확장하기",
    expand_all              : "모두 확장",
    collapse_all            : "모두 축소"
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85437_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "ko" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "ko" +
      "/comment_disclaimer.htm";
  }
