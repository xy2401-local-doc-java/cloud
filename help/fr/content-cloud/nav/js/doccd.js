...
var tSchema = "E85395-01";
var partNumber = "E85395-01";
...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/E85395-01/ranked?advanced=1",
    homepage           : "../index.htm",
    master_index       : "http://www.oracle.com/pls/E85395-01/master_index",
    master_glossary    : "http://www.oracle.com/pls/E85395-01/master_glossary",
    docindex           : "http://www.oracle.com/pls/E85395-01/docindex"
  };
...
var l10n = {
    ...
    hide_navigation         : "Masquer navigation",
    ...
    reference               : "Référence",
    home                    : "Page d'accueil",
    master_index            : "Maître Index",
    master_glossary         : "Maître Glossaire",
    master_book_list        : "Liste maîtresse du livre",
    main_categories         : "catégories",
    security                : "Sécurité",
    contents                : "Sommaire",
    new_changed             : "Nouvelles et modifiées documents",
    reader_comment          : "Lecteur Commentaire",
    subject                 : "sujet",
    from                    : "depuis",
    anonymous               : "Anonyme",
    or                      : " (ou ",
    sign_in                 : "Connexion",
    comment_first_part      : "Commentaires, corrections et suggestions sont transmis aux auteurs chaque semaine.",
    comment_second_part     : "En soumettant, vous confirmez que vous acceptez l' ",
    comment_third_part      : "termes et conditions",
    comment_fourth_part     : ". ",
    comment_fifth_part      : "Utilisez l' ",
    comment_fifth_part_otn  : "Forums OTN",
    comment_sixth_part      : " pour toutes autres questions. ",
    comment_seventh_part    : "Pour obtenir une assistance ou de conseil, déposer une demande de service à travers ",
    comment_eighth_part     : "My Oracle Support",
    submit                  : "Soumettre",
    need_an_example         : "Besoin d'un exemple?",
    tell_us_more            : "Donnez-nous plus",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E85395_01" + "_NAV", error404 = 0,
...
//    hidden.value = tPath;
  ...
  */
  if (tAuthority === "tahiti-stage.us.oracle.com") {
    a1.href = "http://wd0338.oracle.com/archive/cd_ns/E23003_01/html/" + "fr" +
      "/comment_disclaimer.htm";
  } else {
    a1.href = "http://docs.oracle.com/cd/E23003_01/html/" + "fr" +
      "/comment_disclaimer.htm";
  }
