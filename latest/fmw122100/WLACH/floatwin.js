...
function OpenWindowEdocsHelpToc1(){
                var tocwin = window.open('http://docs.oracle.com/middleware/12212/wls/WLACH/core/indexpopup.html', 'newWin1', 'resizable=yes,scrollbars=yes,status=0,width=450,height=600,left='+leftPos+',top=20');
}
...
function OpenWindowEdocsHelpTOC(){
                var tocwin = window.open('http://docs.oracle.com/middleware/12212/wls/WLACH/index.html', 'newWin1', 'resizable=yes,scrollbars=yes,status=0,width=450,height=600,left='+leftPos+',top=20');
}
